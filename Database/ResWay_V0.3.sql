...
CREATE TABLE UserContact (
  usr_id INTEGER NOT NULL AUTO_INCREMENT,
  uc_contact_id INTEGER NOT NULL AUTO_INCREMENT,
  creation_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX User_Address ON UserInfo(usr_inf_addr_street1,usr_inf_addr_street2,usr_inf_addr_apt_num,usr_inf_addr_zip,usr_inf_addr_city,usr_inf_addr_state);

CREATE INDEX User_Email ON UserInfo(usr_inf_email_verified);

CREATE INDEX User_Phone ON UserInfo(usr_inf_phone_verified);

CREATE INDEX User_Details ON UserInfo(usr_inf_suffix,usr_inf_first_name,usr_inf_middle_name,usr_inf_last_name,usr_inf_addr_street1,usr_inf_addr_street2,usr_inf_addr_apt_num,usr_inf_addr_zip,usr_inf_addr_city,usr_inf_addr_state,usr_inf_email_verified,usr_inf_phone_verified);
...
CREATE INDEX ResoListAgent_Details ON ResoProperty(reso_ListAgentNameSuffix,reso_ListAgentFirstName,reso_ListAgentMiddleName ,reso_ListAgentFirstName,reso_ListAgentOfficePhone,reso_ListAgentCellPhone,reso_ListAgentEmail);
